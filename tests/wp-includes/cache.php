...
class Tests_Cache extends WP_UnitTestCase {
	...
	/**
	 * @covers WP_Object_Cache::add_global_groups
	 */
	function &init_cache() {
	 ...
	 */
	function test_wp_object_cache_miss() {
	 ...
	 * @covers WP_Object_Cache::get
	 */
	function test_wp_object_cache_add_get() {
		$key = rand_str();
		$val = rand_str();
	 ...
	 * @covers WP_Object_Cache::get
	 */
	function test_wp_object_cache_add_get_0() {
		$key = rand_str();
		$val = 0;
	 ...
	 * @covers WP_Object_Cache::get
	 */
	function test_wp_object_cache_add_get_null() {
		$key = rand_str();
		$val = null;
	 ...
	 * @covers WP_Object_Cache::get
	 */
	function test_wp_object_cache_add() {
		$key = rand_str();
		$val1 = rand_str();
		$val2 = rand_str();
	 ...
	 */
	function test_wp_object_cache_replace() {
		$key = rand_str();
		$val = rand_str();
		$val2 = rand_str();
	 ...
	 */
	function test_wp_object_cache_set() {
		$key = rand_str();
		$val1 = rand_str();
		$val2 = rand_str();
	 ...
	 */
	function test_wp_object_cache_flush() {
	 ...
	 * @covers WP_Object_Cache::set
	 */
	function test_wp_object_cache_object_refs() {
		$key = rand_str();
	 ...
	 * @covers WP_Object_Cache::set
	 */
	function test_wp_object_cache_incr() {
		$key = rand_str();
	 ...
	 * @covers WP_Object_Cache::set
	 */
	function test_wp_object_cache_decr() {
		$key = rand_str();
	 ...
	 * @covers WP_Object_Cache::set
	 */
	function test_wp_object_cache_delete() {
		$key = rand_str();
		$val = rand_str();
	 ...
	 * @covers WP_Object_Cache::set
	 */
	function test_wp_object_cache_switch_to_blog() {
